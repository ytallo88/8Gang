...
prefix = "!"
name = "~ └┄֟፝ᰱꦿ🚸🌴ཷ𝕭͢𝐀𝐍𝐃𝐈𝐃𝐎🌹💻ི⁸⁸⁸ ུ  | MODS"
rdaftar = "OBRIGADO POR SE REGISTAR PARA SER UM GADO VIP🌴🐃"
rmenu = " BANDIDO DOMINA KARAY:)"
limitt = 10
ban = []
		...
		case 'daftar':
			...
			if (isBanned) return reply(mess.only.benned)
				...
				ben = '```Lista Banido``` :\n'
					...
					break 
				case 'premiumlist':
				prem = '```Lista de Premium └┄֟፝ᰱꦿ🚸🌴ཷ𝕭͢𝐀𝐍𝐃𝐈𝐃𝐎🌹💻ི⁸⁸⁸ ུ MODS``` :\n'
...
//akhir kreator
		    ...
		    case 'map':
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔═══✪ marcando todo mundo fds *${pushname2}* ✪══`+ teks +'╚═══〘 └┄֟፝ᰱꦿ🚸🌴ཷ𝕭͢𝐀𝐍𝐃𝐈𝐃𝐎🌹💻ི⁸⁸⁸ ུ MODS 〙═══', members_id, true)
					break
			    case 'mentionall':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
				...
				case 'clearall':
					...
					reply(`\`\`\`Sucesso deleta todo o chat └┄֟፝ᰱꦿ🚸🌴ཷ𝕭͢𝐀𝐍𝐃𝐈𝐃𝐎🌹💻ི⁸⁸⁸ ུ MODS\`\`\``)
					break
                                case 'bcgc':
					client.updatePresence(from, Presence.composing) 
					if (!isOwner) return reply(mess.only.ownerB)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ *└┄֟፝ᰱꦿ🚸🌴ཷ𝕭͢𝐀𝐍𝐃𝐈𝐃𝐎🌹💻ི⁸⁸⁸ ུ MODS BROADCAST* ]\n\n${body.slice(4)}`)
						}
						reply('Transmissão de sucesso')
					}
					break
				...
				default:
                  ...
                  reply(`Maaf Kak, Command *${prefix}${command}* Não registrado no banco de dados *${prefix}menu*`)
					...
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[└┄֟፝ᰱꦿ🚸🌴ཷ𝕭͢𝐀𝐍𝐃𝐈𝐃𝐎🌹💻ི⁸⁸⁸ ུ MODS]','aqua'), 'Comando não registrado', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
